...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground shadow-soft hover:bg-primary/90 hover:shadow-lg active:scale-[0.98]",
        destructive:
        ...
        accent:
          "bg-accent text-accent-foreground shadow-soft hover:bg-accent/90 hover:shadow-glow-sm active:scale-[0.98]",
        success:
          "bg-success text-success-foreground shadow-soft hover:bg-success/90 active:scale-[0.98]",
        glass:
          "bg-background/80 backdrop-blur-xl border border-border/50 text-foreground hover:bg-background/90 hover:border-border active:scale-[0.98]",
      },
      size: {
